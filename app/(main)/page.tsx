            ...
            <>
              <div className="flex flex-col gap-2 md:flex-row md:gap-4 items-center">
                {!showResult && selectedAnswer !== null && (
                  <button
                    onClick={handleAnswerSubmit}
                    className="flex-1 bg-gradient-to-r from-green-400 to-blue-500 hover:from-green-500 hover:to-blue-600 text-white font-bold text-base md:text-lg tracking-tight text-shadow-sm py-2 px-4 md:py-3 md:px-6 rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center justify-center gap-2 min-h-12"
                  >
                    Submit Answer
                  </button>
                )}
                {showResult && (
                  <>
                    <button
                      ...
                      className="flex-1 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold text-base md:text-lg tracking-tight text-shadow-sm py-2 px-4 md:py-3 md:px-6 rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center justify-center gap-2 min-h-12"
                    >
